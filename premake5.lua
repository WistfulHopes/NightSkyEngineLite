...
function check_raylib()
    if(os.isdir("raylib-nx") == false and os.isdir("raylib-nx") == false) then
...
if (string.lower(workspaceName) == "raylib-nx") then
    print("raylib-nx is a reserved name. Name your project directory something else.")
